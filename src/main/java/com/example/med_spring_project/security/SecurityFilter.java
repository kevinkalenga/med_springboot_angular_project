...
import com.example.med_spring_project.exception.CustomAccessDenialHandler;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(
                        req -> req
                                .requestMatchers("/api/auth/**", "/api/doctors/**")
                                .permitAll()
                                .anyRequest()
                                .authenticated()
                )
                .sessionManagement(
                        (SessionManagementConfigurer<HttpSecurity> mag) ->
